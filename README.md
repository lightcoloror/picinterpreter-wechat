...
- 状态：患者表达与接收理解双向本地闭环已实现；CBoard 全部 44 个默认板已进入分层导航；官方开发者工具 Skill 已完成患者表达、接收理解、独立展示、保存与刷新恢复 E2E；正式 AppID 已添加 WechatSI 插件，插件版已成功推送真机预览，真实发声与录音识别等待手机验收；尚未提交或推送
- 更新时间：`2026-07-22 08:22:37`
